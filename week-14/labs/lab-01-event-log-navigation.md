...
```
(your explanation — what CA operation caused this event?)
```
...
```
(paste any additional events here)
```
...
|---|---|---|
| CRL publication events | Yes / No | |
| CA service start/stop events | Yes / No | |
| Certificate template update events | Yes / No | |
| CA configuration change events | Yes / No | |
| Error events (Level = Error) | Yes / No | |
